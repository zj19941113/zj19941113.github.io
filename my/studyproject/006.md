## 运行准备:
### 1、Ubuntu C++ 编译dlib库 
参照文章：Ubuntu下编译C++与python版Dlib库，附新建样例程序
https://zhoujie1994.cn/my/algorithmic/002.html
### 2、数据+模型下载
百度云盘 https://pan.baidu.com/s/1jIoW6BSa5nkGWNipL7sxVQ
...
![](https://zhoujie1994.cn/my/studyproject/img/006-1.png)
...
## 运行结果：
![](https://zhoujie1994.cn/my/studyproject/img/006-3.png)
### 补充：
python版的看这里 https://zhoujie1994.cn/algorithmic/001.html 
python版的在allface文件夹共375张图片上的识别精度为99.469%，出错的两张是allleft姿态，侧转角度很大。模型算法和这篇c++版是一样的，只是语言不一样。可以看出识别效果还是很好的。this_is_who.py在test-face文件夹中的批量测试结果：

![](https://zhoujie1994.cn/my/studyproject/img/006-5.png)
...
##### 活体检测效果演示：
![](https://zhoujie1994.cn/my/studyproject/img/006-4.gif)